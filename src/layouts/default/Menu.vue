<template>
    <v-list >
        <v-list-item prepend-avatar="https://randomuser.me/api/portraits/men/1.jpg" title="Sam Adams"
          subtitle="sam@bmail.com"></v-list-item>
      </v-list>
      <v-divider></v-divider>
      <v-list density="compact">
        <v-list-item v-for="(item, i) in memenuItems" :key="i" :value="item" :title="item.text" :prependIcon="item.icon" :to="item.path">
        </v-list-item>
      </v-list>
</template>
